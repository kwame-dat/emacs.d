...
(setq org-capture-templates
	...
	("e" "Epic Ticket" entry (file+headline "~/org/tickets.org" "Tickets")
	 (file "~/org/templates/epic.org"))
	("s" "Story Ticket" entry (file+headline "~/org/tickets.org" "Tickets")
	 (file "~/org/templates/story.org"))
	("b" "Bug Ticket" entry (file+headline "~/org/tickets.org" "Tickets")
