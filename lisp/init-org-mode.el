...
(setq org-capture-templates
	...
	("pi" "Personal Inbox" entry (file "~/org/inbox.org")
	 "* TODO %?\n %i\n")
	("pp" "Personal Project" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/project.org"))
	("s" "Spiritual")
	("sb" "Bible Reading" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/bible-reading.org"))
	("sm" "Microphone" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/microphone.org"))
	("sr" "Return Visit" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/return-visit.org"))
	("sc" "Cong. Bible Study Reader" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/cong-bible-study-reader.org"))
	("st" "Talk" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/talk.org"))
	("sw" "Watchtower" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/watchtower-reader.org"))
	("sk" "Kingdom Cleaning" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/cleaning.org"))
	("si" "Initial Call" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/initial-call.org"))
	("sa" "Audio Visual")
	("sam" "Audio Visual Main" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/audio-visual.org"))
	("saa" "Audio Visual Assistant" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/audio-visual-assistant.org"))
	("sab" "Broadcast" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/broadcast.org"))
	("sp" "Prayer/Platform")
	("spo" "Opening Prayer" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/opening-prayer.org"))
	("spc" "Closing Prayer" entry (file+headline "~/org/todo.org" "1Projects")
	 (file "~/org/templates/spiritual/closing-prayer.org"))
	("spp" "Platform" entry (file+headline "~/org/todo.org" "1Projects")
